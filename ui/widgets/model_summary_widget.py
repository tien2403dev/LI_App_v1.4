...
class ModelSummaryWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.table.setStyleSheet("""
            QTableView {background:white; color:black; gridline-color:#333333;
                border:1px solid #333333; font-size:13px;}
            QHeaderView::section {background:#A9D08E; color:black;
                border:1px solid #333333; font-weight:bold; padding:3px;}
        """)
